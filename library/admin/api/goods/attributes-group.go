...
func (g *AttributesGroup) HandlePost(context constrain.IContext) (constrain.IResult, error) {
	gr, err := service.Goods.Attributes.AddGoodsAttributesGroup(g.Organization.ID, g.POST.GoodsID, g.POST.Name)
	if err != nil {
		return nil, err
	}
