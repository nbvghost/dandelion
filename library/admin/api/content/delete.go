...
func (m *Delete) HandlePost(ctx constrain.IContext) (r constrain.IResult, err error) {
	...
	err = dao.DeleteByPrimaryKey(db.GetDB(ctx), entity.Content, dao.PrimaryKey(m.POST.ID))
