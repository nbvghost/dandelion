...
func (m *SubType) HandlePost(ctx constrain.IContext) (r constrain.IResult, err error) {
	//Orm := db.GetDB(ctx)
	...
	err = service.Content.SaveContentSubType(ctx, m.Organization.ID, m.POST.ContentSubType)
