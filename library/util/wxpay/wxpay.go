...
func OrderJS(OrderNo string, ShopName string, DetailJSON string, Host string, openid string, IP string, TotalMoney uint) {
   ...
   <total_fee>` + object.ParseString(TotalMoney) + `</total_fee>
